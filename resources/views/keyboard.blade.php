        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav nav-justified">
                    ...
                    <li class="active"><a href="{{route('teclado')}}">Teclado</a></li>
        ...
        <div class="col-sm-6 col-sm-offset-3">
            <div class="panel panel-default">
                <div class="panel panel-body">
                    ...
                    <center><h2>Carga Por Teclado</h2>

                    <h3>Ops... Lo siento area en Construcción</h3>

                     <img src="img/construccion.png"></center>
